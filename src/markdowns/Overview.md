...
|17|Dictionary|29 bits<br>+<br>1 byte<br>+<br>可変(最大 (2^28 - 1) 要素)|名前と値(どちらも AMF3 でエンコードされたもの)のペア.<br>Object 型との違いは**キーを任意の AMF3 データ型にできる**ことである.<br>[29 bits](#integer-型%2C-長さ%2C-要素の総数) の 1 byte は 1 ならキーが弱参照であることを, 0 ならそうでないことを意味する.|
